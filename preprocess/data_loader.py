...
class TPPNoiseDataset(TPPDataset):
    def __init__(self, data, event_num, eos_elapse=1, add_bos=True, add_eos=True, eps=np.finfo(float).eps,
        ...
        self.seq_statistics = self.update_statistics(self.time_seq)
        print(self.seq_statistics)
...
if __name__ == '__main__':
    ...
    dataset = TPPDataset(data[: 2], 11, concurrent=False, add_eos=False, add_bos=False)
    dataloader = create_dataloader(dataset, 2)
